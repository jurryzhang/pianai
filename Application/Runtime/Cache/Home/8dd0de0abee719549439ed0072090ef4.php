			...
			<div class="main-left">
				...
				<ul class="main-member">
				 <?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
						  	...
						  	<embed src="/Public/Uploads/vcr/<?php echo ($vo['vcrpath']); ?>" type="audio/x-pn-realaudio-plugin" console="Clip1" controls="ControlPanel,StatusBar" height="330" width="250" autostart="true">
                          ...
                          <div class="member_button">
                          	...
                          	<span id="likeit" data-id="<?php echo ($vo['id']); ?>">暗恋她</span>
                          </div> 
					  			</a>
