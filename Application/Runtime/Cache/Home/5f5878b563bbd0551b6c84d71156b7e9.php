...
<div class="couter_box">
		...
		<?php if(is_array($pds)): $i = 0; $__LIST__ = $pds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>用户1:<?php echo ($vo['user1name']); ?>::用户2:<?php echo ($vo['user2name']); ?>
